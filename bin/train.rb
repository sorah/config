...
m = train_info.scan(%r{<td align="left".*?>(?:<font color="White"><b>)?<font class="px12" size="3"><a href="history\.aspx.*?">(.+?)</a>(?:</font></b>)?</font></td><td align="center".*?>(?:<font class="White"><b>)?<font class="px12" size="3">(.+?)</font>}).uniq.map{|x| x.join(":") }
