...
m = train_info.scan(%r{<td align="left" bgcolor="#FF6633" nowrap="nowrap"><font color="White"><b><font class="px12" size="3"><a href="history.aspx.*?">(.+?)</a></font></b></font></td><td align="center" bgcolor="#FF6633" nowrap="nowrap"><font color="White"><b><font class="px12" size="3">(.+?)</font>}).uniq.map{|x| x.join(":") }
